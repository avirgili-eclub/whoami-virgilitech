...
const LINES_ES: TermLine[] = [
  ...
  { type: 'output', text: '  "stack": ["Spring Boot", "Flutter", "Node.js", "Angular", "AI", "Supabase"],' },
  { type: 'output', text: '  "infra": ["Linux", "VPN", "AWS", "Serverless", "EC2"],' },
  { type: 'output', text: '  "data":  ["SQL", "pgvector", "Embeddings"],' },
